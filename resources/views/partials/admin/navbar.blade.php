        ...
        <div class="search-element">
            ...
            <div class="search-result">
                ...
                <div class="search-item">
                    <a href="#">
                        <img class="mr-3 rounded" width="30"
                            src="{{ asset('assets/admin/img/products/product-3-50.png') }}" alt="product">
                ...
                <div class="search-item">
                    <a href="#">
                        <img class="mr-3 rounded" width="30"
                            src="{{ asset('assets/admin/img/products/product-2-50.png') }}" alt="product">
                        Drone X2 New Gen-7
                    </a>
                </div>
                <div class="search-item">
                    <a href="#">
                        <img class="mr-3 rounded" width="30"
                            src="{{ asset('assets/admin/img/products/product-1-50.png') }}" alt="product">
                        Headphone Blitz
                    </a>
                </div>
                <div class="search-header">
    ...
    <ul class="navbar-nav navbar-right">
        ...
        <li class="dropdown"><a href="#" data-toggle="dropdown"
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <a href="/{{ $slug }}/profile" class="dropdown-item has-icon">
                    <i class="far fa-user"></i> Profile
                </a>
                <a href="/{{ $slug }}/subscribe" class="dropdown-item has-icon">
                    <i class="fas fa-bolt"></i> Subscribe
                </a>
                <a href="/{{ $slug }}/setting" class="dropdown-item has-icon">
                ...
                <form action="/{{ $slug }}/logout" method="post">
                    @csrf
                    <button class="btn btn-lg has-icon text-danger">

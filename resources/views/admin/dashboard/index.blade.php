                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <figure class="avatar avatar-xl mr-2">
                            <img src="{{ asset('assets/admin/img/avatar/avatar-1.png') }}" alt="...">
                        </figure>
                        <figure class="avatar avatar-lg mr-2">
                            <img src="{{ asset('assets/admin/img/avatar/avatar-2.png') }}" alt="...">
                        </figure>
                        <figure class="avatar mr-2">
                            <img src="{{ asset('assets/admin/img/avatar/avatar-5.png') }}" alt="...">
                        </figure>
                        <figure class="avatar avatar-sm mr-2">
                            <img src="{{ asset('assets/admin/img/avatar/avatar-3.png') }}" alt="...">
                        </figure>
                        <figure class="avatar avatar-xs mr-2">
                            <img src="{{ asset('assets/admin/img/avatar/avatar-4.png') }}" alt="...">
                        </figure>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-sm-6 col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <figure class="avatar avatar-xl mr-2">
                            <img src="{{ asset('assets/admin/img/avatar/avatar-1.png') }}" alt="...">
                            <img src="{{ asset('assets/admin/img/avatar/avatar-5.png') }}" class="avatar-icon"
                                alt="...">
                        </figure>
                        <figure class="avatar avatar-lg mr-2">
                            <img src="{{ asset('assets/admin/img/avatar/avatar-2.png') }}" alt="...">
                            <img src="{{ asset('assets/admin/img/avatar/avatar-4.png') }}" class="avatar-icon"
                                alt="...">
                        </figure>
                        <figure class="avatar mr-2">
                            <img src="{{ asset('assets/admin/img/avatar/avatar-3.png') }}" alt="...">
                            <img src="{{ asset('assets/admin/img/avatar/avatar-3.png') }}" class="avatar-icon"
                                alt="...">
                        </figure>
                        <figure class="avatar avatar-sm mr-2">
                            <img src="{{ asset('assets/admin/img/avatar/avatar-4.png') }}" alt="...">
                            <img src="{{ asset('assets/admin/img/avatar/avatar-2.png') }}" class="avatar-icon"
                                alt="...">
                        </figure>
                        <figure class="avatar avatar-xs mr-2">
                            <img src="{{ asset('assets/admin/img/avatar/avatar-5.png') }}" alt="...">
                            <img src="{{ asset('assets/admin/img/avatar/avatar-1.png') }}" class="avatar-icon"
                                alt="...">
                        </figure>
                    </div>
                </div>
